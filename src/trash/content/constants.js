...
export const PANEL_WORD_THRESHOLD = 30
export const PANEL_SIZE_COMPACT = { width: 362, height: 271 }
export const PANEL_SIZE_LARGE = { width: 650, height: 390 }

export const INITIAL_PANEL_SIZE = {
